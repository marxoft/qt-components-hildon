...
Dialog {
    ...
    TrackerItemRequest {
        ...
        onStatusChanged: {
            ...
            case 2: {
                try {
                    titleField.text = metaData["Video:Title"];
                }
                catch (e) {
                    titleField.clear();
                }
                ...
                try {
                    authorField.text = metaData["Video:Author"];
                }
                catch (e) {
                    authorField.clear();
                }
                ...
                try {
                    typeLabel.text = metaData["File:Mime"].substring(metaData["File:Mime"].lastIndexOf("/") + 1).toUpperCase() + " " + qsTr("video");
                }
                catch (e) {
                    typeLabel.clear();
                }
                ...
                try {
                    dateLabel.text = Utils.dateStringFromSecs(metaData["File:Modified"]);
                }
                catch (e) {
                    dateLabel.clear();
                }
                ...
                try {
                    timeLabel.text = Utils.timeStringFromSecs(metaData["File:Modified"]);
                }
                catch (e) {
                    timeLabel.clear();
                }
                ...
                try {
                    durationLabel.text = Utils.durationFromSecs(metaData["Video:Duration"]);
                }
                catch (e) {
                    durationLabel.clear();
                }
    ...
    onAccepted: request.setMetaData(
        {
            "Video:Author": authorField.text,
            "Video:Title": titleField.text
        }
    )
}
