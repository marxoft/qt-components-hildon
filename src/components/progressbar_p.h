...
class ProgressBar : public QProgressBar, public QDeclarativeParserStatus
{
    Q_OBJECT
    ...
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), Anchors* anchors READ anchors CONSTANT FINAL)
    ...
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), QDeclarativeListProperty<QObject> data READ data)
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), QDeclarativeListProperty<QWidget> children READ children)
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), QDeclarativeListProperty<QObject> actions READ actions)
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), bool visible READ qmlVisible WRITE setQmlVisible NOTIFY visibleChanged)
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), bool focus READ hasFocus WRITE setFocus NOTIFY focusChanged)
    Q_PRIVATE_PROPERTY(ProgressBar::d_func(), Style* style READ style WRITE setStyle RESET resetStyle)
...
protected:
    ProgressBar(ProgressBarPrivate &dd, QWidget *parent);
