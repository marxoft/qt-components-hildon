...
#ifndef CHECKBOX_P_P_H
#define CHECKBOX_P_P_H

#include "item_p_p.h"
#include "checkbox_p.h"

class CheckBoxPrivate : public ItemPrivate
{

public:
    CheckBoxPrivate(CheckBox *parent) : ItemPrivate(parent) {}
