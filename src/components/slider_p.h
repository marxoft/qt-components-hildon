...
class Slider : public QSlider, public QDeclarativeParserStatus
{
    ...
    Q_PRIVATE_PROPERTY(Slider::d_func(), QDeclarativeListProperty<QWidget> children READ children)
    Q_PRIVATE_PROPERTY(Slider::d_func(), QDeclarativeListProperty<QObject> actions READ actions)
    Q_PRIVATE_PROPERTY(Slider::d_func(), bool visible READ qmlVisible WRITE setQmlVisible NOTIFY visibleChanged)
    Q_PRIVATE_PROPERTY(Slider::d_func(), bool focus READ hasFocus WRITE setFocus NOTIFY focusChanged)
    Q_PRIVATE_PROPERTY(Slider::d_func(), Style* style READ style WRITE setStyle RESET resetStyle)
