...
#ifndef INFORMATIONBOX_P_P_H
#define INFORMATIONBOX_P_P_H

#include "item_p_p.h"
#include "informationbox_p.h"

class InformationBoxPrivate : public ItemPrivate
{

public:
    InformationBoxPrivate(InformationBox *parent) :
        ItemPrivate(parent)
    {
    }
