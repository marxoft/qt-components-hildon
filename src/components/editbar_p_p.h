...
#ifndef EDITBAR_P_P_H
#define EDITBAR_P_P_H

#include "item_p_p.h"
#include "editbar_p.h"

class EditBarPrivate : public ItemPrivate
{

public:
    EditBarPrivate(EditBar *parent) : ItemPrivate(parent) {}
