...
#ifndef PROGRESSBAR_P_P_H
#define PROGRESSBAR_P_P_H

#include "item_p_p.h"
#include "progressbar_p.h"

class ProgressBarPrivate : public ItemPrivate
{

public:
    ProgressBarPrivate(ProgressBar *parent) : ItemPrivate(parent) {}
