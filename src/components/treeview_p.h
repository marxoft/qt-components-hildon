...
class TreeView : public QTreeView, public QDeclarativeParserStatus
{
    Q_OBJECT
    ...
    Q_PRIVATE_PROPERTY(TreeView::d_func(), Anchors* anchors READ anchors CONSTANT FINAL)
    ...
    Q_PROPERTY(QHeaderView* header READ header WRITE setHeader)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QDeclarativeListProperty<QObject> data READ data)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QDeclarativeListProperty<QWidget> children READ children)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QDeclarativeListProperty<QObject> actions READ actions)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), bool visible READ qmlVisible WRITE setQmlVisible NOTIFY visibleChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), bool focus READ hasFocus WRITE setFocus NOTIFY focusChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QVariant model READ model WRITE setModel NOTIFY modelChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QVariant rootIndex READ rootIndex WRITE setRootIndex NOTIFY rootIndexChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QVariant currentIndex READ currentIndex WRITE setCurrentIndex NOTIFY currentIndexChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QVariantList selectedIndexes READ selectedIndexes WRITE setSelectedIndexes NOTIFY currentIndexChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), QDeclarativeComponent* delegate READ delegate WRITE setDelegate NOTIFY delegateChanged)
    Q_PRIVATE_PROPERTY(TreeView::d_func(), Style* style READ style WRITE setStyle RESET resetStyle)
...
protected:
    TreeView(TreeViewPrivate &dd, QWidget *parent = 0);
    ...
    QScopedPointer<TreeViewPrivate> d_ptr;
