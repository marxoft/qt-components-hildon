...
#ifndef SPINBOX_P_P_H
#define SPINBOX_P_P_H

#include "item_p_p.h"
#include "spinbox_p.h"

class SpinBoxPrivate : public ItemPrivate
{

public:
    SpinBoxPrivate(SpinBox *parent) : ItemPrivate(parent) {}
