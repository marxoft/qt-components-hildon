...
#ifndef RADIOBUTTON_P_P_H
#define RADIOBUTTON_P_P_H

#include "item_p_p.h"
#include "radiobutton_p.h"

class RadioButtonPrivate : public ItemPrivate
{

public:
    RadioButtonPrivate(RadioButton *parent) : ItemPrivate(parent) {}
