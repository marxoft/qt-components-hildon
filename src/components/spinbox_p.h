...
class SpinBox : public QSpinBox, public QDeclarativeParserStatus
{
    ...
    Q_PRIVATE_PROPERTY(SpinBox::d_func(), bool focus READ hasFocus WRITE setFocus NOTIFY focusChanged)
    Q_PRIVATE_PROPERTY(SpinBox::d_func(), Style* style READ style WRITE setStyle RESET resetStyle)
